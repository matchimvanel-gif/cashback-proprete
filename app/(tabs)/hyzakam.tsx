...
export default function ecranHyzakam() {
    ...
    const onglets = [
        ...
        { id: 'partenaires',  icone: 'storefront-outline',    iconeActif: 'storefront', label: 'Partenaires' },
        { id: 'responsables', icone: 'people-outline',        iconeActif: 'people',    label: 'Responsable'      },
        { id: 'statistiques', icone: 'bar-chart-outline',     iconeActif: 'bar-chart', label: 'Statistique'       },
    ]
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => setMenuOuvert(!menuOuvert)}>
                            <Ionicons name="menu" size={28} color={couleur.dore}
                            style={{marginTop:15}} />
                        </TouchableOpacity>
                    </View>
